...
# ============================================================
# Building blocks identical to UKAN_base.
# ============================================================
...
class KANBlock(nn.Module):
    def __init__(self, dim, drop=0., drop_path=0., act_layer=nn.GELU,
        ...
        self.layer = KANLayer(in_features=dim, hidden_features=int(dim),
...
# ============================================================
# UKAN_edl: final layer outputs 2 channels and forward returns raw logits.
# ============================================================

class UKAN_edl(nn.Module):
    """
    UKAN with Evidential Deep Learning head.
    Differences from UKAN_base:
      1. self.final outputs 2 channels (background + foreground)
      2. forward() returns raw logits without sigmoid/softmax

    Use EDLDiceLoss(logits, masks, epoch) during training.
    Use edl_inference(logits) during inference.
    """
    ...
    def __init__(self, num_classes=2, input_channels=3, deep_supervision=False,
        ...
        # Enforce num_classes=2 for EDL binary segmentation.
        assert num_classes == 2, "EDL binary segmentation requires num_classes=2"
        ...
        # EDL head: output 2 channels for background and foreground evidence.
    ...
    def forward(self, x):
        ...
        # Return raw logits without activation.
